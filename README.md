...
Before running the script, ensure you have Python 3 and the necessary libraries installed.

1. Python 3.x
2. `secrets` library (comes pre-installed with Python)
...
The script will ask for the target IP and port to attack. Provide the necessary details when prompted.
